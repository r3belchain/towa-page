        ...
        >
          ...
          <div className="sticky top-[5vh] flex h-[90vh] w-full items-center justify-center overflow-hidden rounded-[2rem] border border-towa-border/50 bg-towa-bg-alt shadow-2xl">
            ...
            <motion.div
              ...
              className="pointer-events-none relative z-10 flex flex-col items-center justify-center rounded-3xl border border-towa-border/30 bg-towa-bg/80 p-10 text-center shadow-2xl backdrop-blur-xl transition-colors"
            >
              <SectionHeading
                eyebrow="Cerita Warga"
                title="Momen Asbun"
